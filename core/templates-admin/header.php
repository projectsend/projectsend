	...
	<div class="container-custom">
		<header id="header" class="navbar navbar-static-top navbar-fixed-top">
			...
			<div class="navbar-header">
				<span class="navbar-brand"><a href="<?php echo SYSTEM_URI; ?>" target="_blank"><?php include(ASSETS_IMG_DIR . '/ps-icon.svg'); ?></a> <?php echo html_output(THIS_INSTALL_SET_TITLE); ?></span>
			</div>
