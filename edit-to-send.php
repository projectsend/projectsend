...
<h3>
  ...
  //_e('Files uploaded correctly','cftp_admin'); 
  $cc_status = '<div class="alert alert-success"><a href="#" class="close" data-dismiss="alert">×</a>The file Sent successfully.</div>'; 
  echo isset($cc_status)? $cc_status : '';
...
/*=======================================================================end addition==================================================================*/		
	...
	?>
          ...
          <form action="edit-to-send.php?file_id=<?php echo filter_var($this_file_id,FILTER_VALIDATE_INT); ?>&page_id=<?php echo $get_prev_id; ?>" method="post" name="edit_file" id="edit_file">
