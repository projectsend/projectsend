...
/**
 * Match and return an appropriate filetype icon in svg
 */
function make_filetype_thumbnail($file, $type = 'thumbnail', $width = THUMBS_MAX_WIDTH, $height = THUMBS_MAX_HEIGHT, $quality = THUMBS_QUALITY)
{
    $thumbnail = array();
