...
$json_strings = [
    ...
    'validation'	=> [
		...
		'user_exists'				=> __('A system user or client with this login name already exists.','cftp_admin'),
		'email_exists'				=> __('A system user or client with this e-mail address already exists.','cftp_admin'),
