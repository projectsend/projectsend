...
$json_strings = [
    ...
    'translations' => [
        ...
        'file_encryption_modal_title' => __('File encryption information','cftp_admin'),
        'confirm_copied_all_keys' => __('I have copied all the keys. Continue.','cftp_admin'),
        'confirm_cancel_copy_keys' => __('Confirm changing the files list and reset all keys?','cftp_admin'),
        'public_url' => __('Public URL','cftp_admin'),
        'upload_no_files_selected' => __('Please select at least one file to upload.','cftp_admin'),
