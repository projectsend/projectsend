                    ...
                    <div class="alert alert-warning update_msg">
                        <div class="row">
                            ...
                            <div class="col-sm-4 text-right">
                                <a href="<?php echo $update_data->url; ?>" class="btn btn-pslight btn-xs" target="_blank"><?php _e('Download', 'cftp_admin');?></a> <a href="<?php echo $update_data->chlog; ?>" target="_blank" class="btn btn-pslight btn-xs"><?php _e('Changelog', 'cftp_admin');?></a>
                            </div>
                        </div>
                    </div>
<?php
