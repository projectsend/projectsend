...
switch ($organization_form_type) {
	case 'new_organization':
		...
		$form_action = 'organization-add-user.php';
		break;
	case 'edit_organization':
		$submit_value = __('Save Organization','cftp_admin');
		$form_action = 'organization-edit-user.php?id='.$group_id;
		break;
}
?>
...
<form action="<?php echo html_output($form_action); ?>" name="addgroup" method="post" class="form-horizontal">
	...
	<div class="inside_form_buttons cc-text-right">
               <a href="<?php echo BASE_URI; ?>userorganization.php" name="cancel" class="btn btn-wide btn-default"><?php _e('Cancel','cftp_admin'); ?></a>
