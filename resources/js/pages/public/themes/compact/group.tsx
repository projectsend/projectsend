...
export default function PublicGroupShowCompact({ group, files, pagination }: PublicGroupShowProps) {
    const { t } = useTranslation();

    return (
        <PublicLayoutCompact title={group.name} description={group.description ?? undefined}>
