      ...
      <div class="row">
		...
		if ( $query_table_files === true ) {
			...
			*/
			...
			$q_sent_file = "SELECT  tbl_files.* FROM tbl_files LEFT JOIN tbl_files_relations ON tbl_files.id = tbl_files_relations.file_id where tbl_files_relations.from_id =" . CURRENT_USER_ID;
