...
use Facebook\HttpClients\FacebookHttpable;
	...
	$helper = new FacebookRedirectLoginHelper(BASE_URI."sociallogin/facebook_special/fbconfig.php" );
...
if ( isset( $session ) ) {
	...
	header("Location: ".BASE_URI."/sociallogin/login-with.php?provider=Facebook");
