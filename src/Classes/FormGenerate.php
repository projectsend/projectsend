...
class FormGenerate extends Base
{
    ...
    protected $checkbox_group_class;
    protected $label_class;
    protected $wrap_class;
    protected $wrap_group;
    protected $checkbox_wrap;
    protected $field_class;
    protected $password_toggle_wrap;
    protected $password_toggle_btn;
    protected $new_password_fields;
    protected $ignore_field_class;
    protected $ignore_layout;
